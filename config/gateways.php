        ...
        'cajupay' => [
            ...
            'credential_keys' => [
                ...
                [
                    ...
                    'type' => 'password',
                    'optional' => true,
                    'hint' => 'Cole o token no formato cwhsec_… exibido uma vez no painel CajuPay (Webhooks) ou na resposta do POST /api/webhooks/endpoints. Necessário para validar as notificações de pagamento no Hiperlink. Deixe em branco ao salvar para manter o token já gravado.',
                ],
            ],
        ],
        'spacepag' => [
            ...
            'credential_keys' => [
                ...
                [
                    ...
                    'label' => 'Chave privada',
                    'type' => 'password',
                    'hint' => 'Chave privada / secret (sk_live_… ou sk_test_…). O Hiperlink testa automaticamente: X-API-Key com sk, pk+sk (X-API-Key + X-API-Secret) ou só pk, conforme a API aceitar.',
                ],
                [
                    'key' => 'webhook_secret',
                    ...
                    'type' => 'password',
                    'optional' => true,
                    'hint' => 'Ao criar o webhook na Spacepag apontando para a URL do Hiperlink, copie o secret retornado. Com ele o Hiperlink valida o header X-Webhook-Signature (HMAC SHA-256 do corpo). Cadastre na Spacepag a URL: https://SEU_DOMINIO/webhooks/gateways/spacepag . Deixe em branco ao salvar para manter o secret já gravado.',
                ],
            ],
        ],
        'efi' => [
